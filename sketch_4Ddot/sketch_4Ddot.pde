...
void draw() {
  ...
  */
  ...
  fieldDataSegs[1][1][1][2][0] = true;
  fieldDataSegs[1][1][1][2][2] = true;
  fieldDataSegs[2][1][1][2][2] = true;
  fieldDataSegs[1][1][2][2][0] = true;
  
  findAndSetSquares(fieldDataSegs, fieldDataSquares, 0, 0, 0, 0, player.p1);
  findAndSetSquares(fieldDataSegs, fieldDataSquares, 0, 0, 0, 1, player.p1);
  findAndSetSquares(fieldDataSegs, fieldDataSquares, 0, 0, 0, 2, player.p1);
  findAndSetSquares(fieldDataSegs, fieldDataSquares, 1, 1, 1, 2, player.p1);
  ...
  */
  ...
  //drawSegFace(1, 1, 0, 1, 1, 1, 0, millis()/8000.0*PI, PI*sin(millis()/4000.0*PI)/20);
  //drawFaces(fieldDataSquares, millis()/8000.0*PI, PI*sin(millis()/4000.0*PI)/20);
